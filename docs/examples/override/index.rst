...
It provides interconnected services and calls things.
But as a consumer, we'd like to "override" one of the built-in services, without having to fork the caller or callee.
