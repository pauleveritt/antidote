...
from antidote import implements, interface, typeclasses, world
...
class Weighted:
    ...
    def merge(a: Weighted, b: Weighted) -> Weighted:
...
class GreaterThan:
    ...
    @staticmethod
    @typeclasses.predicate.merge_constraint
    def merge(a: GreaterThan, b: GreaterThan) -> GreaterThan:
